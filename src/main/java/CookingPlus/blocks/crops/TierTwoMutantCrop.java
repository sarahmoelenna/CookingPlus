...
public class TierTwoMutantCrop extends CookingPlusCustomCrops
{

	private final String name = "twomutantcrop";
	
    public TierTwoMutantCrop()
    {
        // Basic block setup
        this.setUnlocalizedName("twomutantcrop");
        GameRegistry.registerBlock(this, "twomutantcrop");
    }
    ...
    public void setToRandomCrop(Random parRand, World parWorld, BlockPos myPos, IBlockState myState){
    	parWorld.setBlockState(myPos, (MutationStationRecipeHandler.instance().getRandomCrop(2, parRand)).getDefaultState().withProperty(CookingPlusCustomCrops.AGE, 7));
    }
