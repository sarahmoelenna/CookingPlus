...
public class TierFourMutantCrops extends CookingPlusCustomCrops
{

	private final String name = "fourmutantcrop";
	
    public TierFourMutantCrops()
    {
        // Basic block setup
        this.setUnlocalizedName("fourmutantcrop");
        GameRegistry.registerBlock(this, "fourmutantcrop");
    }
    ...
    public void setToRandomCrop(Random parRand, World parWorld, BlockPos myPos, IBlockState myState){
    	parWorld.setBlockState(myPos, (MutationStationRecipeHandler.instance().getRandomCrop(4, parRand)).getDefaultState().withProperty(CookingPlusCustomCrops.AGE, 7));
    }
