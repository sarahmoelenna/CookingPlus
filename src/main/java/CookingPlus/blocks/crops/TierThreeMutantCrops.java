...
public class TierThreeMutantCrops extends CookingPlusCustomCrops
{

	private final String name = "threemutantcrop";
	
    public TierThreeMutantCrops()
    {
        // Basic block setup
        this.setUnlocalizedName("threemutantcrop");
        GameRegistry.registerBlock(this, "threemutantcrop");
    }
    ...
    public void setToRandomCrop(Random parRand, World parWorld, BlockPos myPos, IBlockState myState){
    	parWorld.setBlockState(myPos, (MutationStationRecipeHandler.instance().getRandomCrop(3, parRand)).getDefaultState().withProperty(CookingPlusCustomCrops.AGE, 7));
    }
