...
public class TierOneMutantCrop extends CookingPlusCustomCrops
{

	private final String name = "mutantcrop";
	
    public TierOneMutantCrop()
    {
        // Basic block setup
        this.setUnlocalizedName("onemutantcrop");
    ...
    public void setToRandomCrop(Random parRand, World parWorld, BlockPos myPos, IBlockState myState){
    	parWorld.setBlockState(myPos, (MutationStationRecipeHandler.instance().getRandomCrop(1, parRand)).getDefaultState().withProperty(CookingPlusCustomCrops.AGE, 7));
    }
