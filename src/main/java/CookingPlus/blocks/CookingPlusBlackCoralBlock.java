...
public class CookingPlusBlackCoralBlock extends CookingPlusCustomTranslucentCoral {
	...
	private final String name = "blackcoralblock";
	
	public CookingPlusBlackCoralBlock(){
		super();
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos myPos, IBlockState myState, int fortune)
    {
        ...
        ret.add(new ItemStack(CookingPlusMain.blockBlackCoral, myRand.nextInt(2) + 1, 0)); //always drops at least one seed
