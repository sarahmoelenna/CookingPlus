...
public class CookingPlusDiamondRangeBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "diamondrangeblock";
	
	public CookingPlusDiamondRangeBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CookingPlusDiamondRangeBlockTileEntity();
	}
