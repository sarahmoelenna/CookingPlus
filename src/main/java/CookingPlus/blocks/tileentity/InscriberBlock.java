...
public class InscriberBlock extends CookingPlusCustomTileEntityBlock {

	 	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
		private final String name = "inscriber";
		
        public InscriberBlock() {
                super(Material.IRON);
                this.setUnlocalizedName("inscriber");
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	            ...
	            {
	                InventoryHelper.dropInventoryItems(worldIn, pos, (InscriberTileEntity)tileentity);
	            }
