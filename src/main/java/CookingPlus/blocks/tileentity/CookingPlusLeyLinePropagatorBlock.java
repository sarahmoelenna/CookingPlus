...
public class CookingPlusLeyLinePropagatorBlock extends CookingPlusCustomTileEntityBlock{

	private final String name = "leylinepropagator";
	
	
	public CookingPlusLeyLinePropagatorBlock() {
		super(Material.IRON);
		GameRegistry.registerBlock(this, name);
		this.setUnlocalizedName("leylinepropagator");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new LeyLinePropagatorTileEntity();
	}
