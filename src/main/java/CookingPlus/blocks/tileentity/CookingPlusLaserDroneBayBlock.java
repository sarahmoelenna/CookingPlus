...
public class CookingPlusLaserDroneBayBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "laserdronebayblock";
	
	public CookingPlusLaserDroneBayBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new LaserDroneBayTileEntity();
	}
