...
public class CookingPlusSpeedBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "speedblock";
	
	public CookingPlusSpeedBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CookingPlusSpeedBlockTileEntity();
	}
