...
public class CookingPlusLoggerBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "loggerblock";
	
	public CookingPlusLoggerBlock() {
		super(Material.IRON);
