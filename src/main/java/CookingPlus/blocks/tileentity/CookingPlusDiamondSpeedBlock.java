...
public class CookingPlusDiamondSpeedBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "diamondspeedblock";
	
	public CookingPlusDiamondSpeedBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CookingPlusDiamondSpeedBlockTileEntity();
	}
