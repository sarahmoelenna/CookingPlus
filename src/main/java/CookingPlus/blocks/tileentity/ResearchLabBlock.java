...
public class ResearchLabBlock extends CookingPlusCustomTileEntityBlock {

	 	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
		private final String name = "researchlab";
		
        public ResearchLabBlock() {
                super(Material.IRON);
                this.setUnlocalizedName("researchlab");
		...
		public TileEntity createNewTileEntity(World var1, int var2) {
			return new ResearchLabTileEntity();
		}
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	            ...
	            {
	                InventoryHelper.dropInventoryItems(worldIn, pos, (ResearchLabTileEntity)tileentity);
	            }
