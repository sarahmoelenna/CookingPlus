...
public class CookingPlusGoldenSpeedBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "goldenspeedblock";
	
	public CookingPlusGoldenSpeedBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CookingPlusGoldenSpeedBlockTileEntity();
	}
