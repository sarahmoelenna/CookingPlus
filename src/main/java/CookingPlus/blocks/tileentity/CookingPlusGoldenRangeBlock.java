...
public class CookingPlusGoldenRangeBlock extends CookingPlusCustomTileEntityBlock {

	private final String name = "goldenrangeblock";
	
	public CookingPlusGoldenRangeBlock() {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CookingPlusGoldenRangeBlockTileEntity();
	}
