...
public class CookingPlusCherrySapling extends CookingPlusCustomSapling {

	private final String name = "cherrysapling";
	
	public CookingPlusCherrySapling() {
		super("cherrysapling");
	...
	public void GenTree(World myWorld, int x, int y, int z, Random myRand){
    	WorldGenerator myGen = new CookingPlusGenOriginalTree(Blocks.log, CookingPlusMain.blockCherryLeaves, 0, 0, 3);
