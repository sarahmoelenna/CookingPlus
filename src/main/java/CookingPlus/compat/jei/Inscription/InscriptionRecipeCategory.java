...
public class InscriptionRecipeCategory implements IRecipeCategory<InscriptionRecipeWrapper> {

	public static final String UID = "cookingplus.inscription";
	...
	public InscriptionRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("cookingplus.jei.inscription");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout,InscriptionRecipeWrapper recipeWrapper) {
		// TODO Auto-generated method stub
