...
public class IceBoxRecipeCategory implements IRecipeCategory<IceBoxRecipeWrapper> {

	public static final String UID = "cookingplus.icebox";
	...
	public IceBoxRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("cookingplus.jei.icebox");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout,IceBoxRecipeWrapper recipeWrapper) {
		// TODO Auto-generated method stub
