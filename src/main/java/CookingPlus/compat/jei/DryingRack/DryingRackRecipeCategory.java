...
public class DryingRackRecipeCategory implements IRecipeCategory<DryingRackRecipeWrapper> {
	...
	public static final String UID = "cookingplus.dryingrack";
	...
	public DryingRackRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("cookingplus.jei.dryingrack");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout,DryingRackRecipeWrapper recipeWrapper) {
		// TODO Auto-generated method stub
