...
public class FishBreedRecipeCategory implements IRecipeCategory<FishBreedRecipeWrapper> {

	public static final String UID = "cookingplus.fishbreed";
	...
	public FishBreedRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("cookingplus.jei.fishbreed");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout,FishBreedRecipeWrapper recipeWrapper) {
		// TODO Auto-generated method stub
		...
		guiItemStacks.setFromRecipe(inputSlotTwo, recipeWrapper.getInputs());
