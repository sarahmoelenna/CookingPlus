...
public class RangeBlockRenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/rangeblockmap.png");
	
	private CookingPlusGatherer model;
	
	public RangeBlockRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		CookingPlusRangeBlockTileEntity myentity = (CookingPlusRangeBlockTileEntity) entity;
