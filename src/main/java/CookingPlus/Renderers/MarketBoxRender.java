...
public class MarketBoxRender extends TileEntitySpecialRenderer {
	EntityItem entItem;
	ResourceLocation texture = new ResourceLocation("cookingplus:textures/blocks/marketboxmap.png");
		 ...
		 if(MyOven.getStackInSlot(slot) != null){
			...
			//itemstack render
			 ...
			 //RenderItem.renderInFrame = true;
			 	...
			 	GL11.glTranslatef(0.23F, 0.15f, -0.2F);
			 	...
			 	GL11.glTranslatef(0.23F, 0.16f, -0.4F);
			 	GL11.glRotatef(90, 1, 0, 0);
			 	GL11.glScalef(0.8f, 0.8f, 0.8f);
			 	Minecraft.getMinecraft().getRenderManager().renderEntityWithPosYaw(this.entItem, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F);
			 	GL11.glPopMatrix();
			 	...
			 	GL11.glTranslatef(-0.25F, 0.19f, -0.2F);
			 	GL11.glRotatef(90, 1, 0, 0);
			 	GL11.glScalef(0.8f, 0.8f, 0.8f);
			 	Minecraft.getMinecraft().getRenderManager().renderEntityWithPosYaw(this.entItem, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F);
			 	GL11.glPopMatrix();
			 	...
			 	GL11.glTranslatef(-0.25F, 0.20f, -0.4F);
			 	GL11.glRotatef(90, 1, 0, 0);
			 	GL11.glScalef(0.8f, 0.8f, 0.8f);
			 	Minecraft.getMinecraft().getRenderManager().renderEntityWithPosYaw(this.entItem, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F);
			 	GL11.glPopMatrix();
