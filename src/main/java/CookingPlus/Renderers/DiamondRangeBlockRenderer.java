...
public class DiamondRangeBlockRenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/diamondrangeblockmap.png");
	
	private CookingPlusGatherer model;
	
	public DiamondRangeBlockRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		CookingPlusDiamondRangeBlockTileEntity myentity = (CookingPlusDiamondRangeBlockTileEntity) entity;
