...
public class PlanterRenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/plantermap.png");
	
	private CookingPlusGatherer model;
	
	public PlanterRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		PlanterTileEntity myentity = (PlanterTileEntity) entity;
