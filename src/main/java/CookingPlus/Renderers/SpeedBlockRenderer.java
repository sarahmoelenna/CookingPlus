...
public class SpeedBlockRenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/speedblockmap.png");
	
	private CookingPlusGatherer model;
	
	public SpeedBlockRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		CookingPlusSpeedBlockTileEntity myentity = (CookingPlusSpeedBlockTileEntity) entity;
