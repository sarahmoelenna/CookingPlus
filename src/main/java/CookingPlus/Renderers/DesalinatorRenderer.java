...
public class DesalinatorRenderer extends TileEntitySpecialRenderer {
	...
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/desalinatormap.png");
	
	private CookingPlusGatherer model;
	
	public DesalinatorRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		DesalinatorTileEntity myentity = (DesalinatorTileEntity) entity;
