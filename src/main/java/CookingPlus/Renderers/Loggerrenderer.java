...
public class Loggerrenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/loggermap.png");
	
	private CookingPlusGatherer model;
	
	public Loggerrenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		LoggerTileEntity myentity = (LoggerTileEntity) entity;
