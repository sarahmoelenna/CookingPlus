...
public class GoldenRangeBlockRenderer extends TileEntitySpecialRenderer {
	
	ResourceLocation texture = new ResourceLocation("agriculturalrevolution:textures/blocks/goldenrangeblockmap.png");
	
	private CookingPlusGatherer model;
	
	public GoldenRangeBlockRenderer(){
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f, int dunno) {
		...
		CookingPlusGoldenRangeBlockTileEntity myentity = (CookingPlusGoldenRangeBlockTileEntity) entity;
