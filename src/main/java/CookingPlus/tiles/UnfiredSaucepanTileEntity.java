...
public class UnfiredSaucepanTileEntity extends CookingPlusCustomTileEntity implements IInventory, ITickable {

	private int EntityDirection;
	private ItemStack[] inv;
	
	public UnfiredSaucepanTileEntity() {
		EntityDirection = 0;
		inv = new ItemStack[3];
	}
    ...
    {
		if(oldState.getBlock().equals(CookingPlusMain.blockUnfiredSaucePan) == true){
			if(newSate.getBlock().equals(CookingPlusMain.blockUnfiredSaucePan) == false){
