...
public class UnfiredTeapotTileEntity extends CookingPlusCustomTileEntity implements IInventory, ITickable {
	...
	public UnfiredTeapotTileEntity() {
		EntityDirection = 0;
		inv = new ItemStack[5];
		LiquidAmount = 0;
		canBoil = false;
    ...
    {
		if(oldState.getBlock().equals(CookingPlusMain.blockUnfiredTeapot) == true){
			if(newSate.getBlock().equals(CookingPlusMain.blockUnfiredTeapot) == false){
