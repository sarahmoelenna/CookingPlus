...
public class LeyLineGeneratorTileEntity extends CookingPlusCustomTileEntity implements ILeyLineProducer, ITickable {
	...
	public LeyLineGeneratorTileEntity(){
		north = 1;
		south = 1;
		east = 1;
		west = 1;
    ...
    {
		if(oldState.getBlock().equals(CookingPlusMain.blockLeyGenerator) == true){
			if(newSate.getBlock().equals(CookingPlusMain.blockLeyGenerator) == false){
	...
	public void checkConnectedSides(){
		if(this.getWorld().getBlockState(getPos().up()).getBlock() == CookingPlusMain.blockLeyDesynth){
			up = 0;
		}
		else{
			if(up == 0){
		...
		if(this.getWorld().getBlockState(getPos().down()).getBlock() == CookingPlusMain.blockLeyDesynth){
			down = 0;
		}
		else{
			if(down == 0){
		...
		if(this.getWorld().getBlockState(getPos().east()).getBlock() == CookingPlusMain.blockLeyDesynth){
			east = 0;
		}
		else{
			if(east == 0){
		...
		if(this.getWorld().getBlockState(getPos().west()).getBlock() == CookingPlusMain.blockLeyDesynth){
			west = 0;
		}
		else{
			if(west == 0){
		...
		if(this.getWorld().getBlockState(getPos().north()).getBlock() == CookingPlusMain.blockLeyDesynth){
			north = 0;
		}
		else{
			if(north == 0){
		...
		if(this.getWorld().getBlockState(getPos().south()).getBlock() == CookingPlusMain.blockLeyDesynth){
			south = 0;
		}
		else{
			if(south == 0){
