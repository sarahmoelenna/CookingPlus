...
import ModelBoxes.CookingPlusLeyDesynthCrystalModelBox;

public class CookingPlusLeyCrystal extends ModelBase
{
  //fields
    ModelRenderer Shape15;
  
  public CookingPlusLeyCrystal()
  {
    textureWidth = 16;
    textureHeight = 16;
      ...
      Shape15.cubeList.add(new CookingPlusLeyDesynthCrystalModelBox(Shape15));
