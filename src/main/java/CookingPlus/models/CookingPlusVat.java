...
public class CookingPlusVat extends ModelBase
{
  ...
  public CookingPlusVat()
  {
    textureWidth = 64;
    textureHeight = 64;
 
      Shape15 = new ModelRenderer(this, 0, 0);
      Shape15.cubeList.add(new CookingPlusVatModelBox(Shape15));
      ...
      Shape2.cubeList.add(new CookingPlusFetusGrownModelBox(Shape2));
      ...
      Shape1.cubeList.add(new CookingPlusFetusSmallModelBox(Shape1));
  ...
  public void RenderFetusModel(float f5, boolean small)
  {
	  if(small == true){
		  Shape1.render(f5);
	  }
