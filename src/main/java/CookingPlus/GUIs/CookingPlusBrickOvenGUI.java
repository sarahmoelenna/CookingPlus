...
public class CookingPlusBrickOvenGUI  extends GuiContainer
{
    ...
    public CookingPlusBrickOvenGUI(InventoryPlayer parInventoryPlayer, TileEntity parInventoryGrinder)
    {
        super(new CookingPlusBrickOvenContainer(parInventoryPlayer, parInventoryGrinder));
        inventoryPlayer = parInventoryPlayer;
        tileGrinder = (BrickOvenTileEntity) parInventoryGrinder;
    }
