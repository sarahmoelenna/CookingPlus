...
public class CookingPlusInscriberGUI  extends GuiContainer
{
    private static final ResourceLocation GuiTextures = new ResourceLocation("agriculturalrevolution:textures/gui/inscribergui.png");
    private final InventoryPlayer inventoryPlayer;
    private final InscriberTileEntity tileGrinder;

    public CookingPlusInscriberGUI(InventoryPlayer parInventoryPlayer, TileEntity parInventoryGrinder)
    {
        super(new CookingPlusInscriberContainer(parInventoryPlayer, parInventoryGrinder));
        inventoryPlayer = parInventoryPlayer;
        tileGrinder = (InscriberTileEntity) parInventoryGrinder;
    }
