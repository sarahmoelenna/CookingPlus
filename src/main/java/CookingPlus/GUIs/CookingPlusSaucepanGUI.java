...
public class CookingPlusSaucepanGUI  extends GuiContainer
{
    ...
    private final SaucepanTileEntity tileGrinder;

    public CookingPlusSaucepanGUI(InventoryPlayer parInventoryPlayer, TileEntity parInventoryGrinder)
    {
        super(new CookingPlusSaucepanContainer(parInventoryPlayer, parInventoryGrinder));
        inventoryPlayer = parInventoryPlayer;
        tileGrinder = (SaucepanTileEntity) parInventoryGrinder;
