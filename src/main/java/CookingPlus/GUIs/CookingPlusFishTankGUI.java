...
public class CookingPlusFishTankGUI  extends GuiContainer
{
    ...
    private final FishTankTileEntity tileGrinder;

    public CookingPlusFishTankGUI(InventoryPlayer parInventoryPlayer, TileEntity parInventoryGrinder)
    {
        super(new CookingPlusIceBoxContainer(parInventoryPlayer, parInventoryGrinder));
        inventoryPlayer = parInventoryPlayer;
        tileGrinder = (FishTankTileEntity) parInventoryGrinder;
    }
