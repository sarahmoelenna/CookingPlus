...
public class CookingPlusBrickOvenContainer extends Container {
	...
	public CookingPlusBrickOvenContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
		// DEBUG
		...
		addSlotToContainer(new CookingPlusFuelSlot(tileGrinder, 9, 80, 37)); // fuel - 9
