...
public class CookingPlusInscriberContainer extends Container {
	...
	public CookingPlusInscriberContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
		// DEBUG
