...
public class CookingPlusFryingPanContainer extends Container {
	...
	public CookingPlusFryingPanContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
		// DEBUG
