...
public class CookingPlusAnalyserContainer extends Container {
	...
	public CookingPlusAnalyserContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
		// DEBUG
		...
		addSlotToContainer(new CookingPlusSingleSlot(tileGrinder, 1, 80, 56)); // input - 2
