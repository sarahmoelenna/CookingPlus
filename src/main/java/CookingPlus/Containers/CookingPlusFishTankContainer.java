...
public class CookingPlusFishTankContainer extends Container {
	...
	public CookingPlusFishTankContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
