...
public class CookingPlusMutationStationContainer extends Container {
	...
	public CookingPlusMutationStationContainer(InventoryPlayer parInventoryPlayer,TileEntity tileEntity) {
		// DEBUG
		...
		int i;
		addSlotToContainer(new CookingPlusSingleSlot(tileGrinder, 0, 26, 53)); // input - 1
		
		addSlotToContainer(new CookingPlusSingleSlot(tileGrinder, 1, 80, 53)); // input - 2
